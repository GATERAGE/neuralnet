...
#
# The canonical content now lives at `neuralnet.transformer_rage`.
...
#
"""Deprecation shim for `production_transformer_rage`. See module docstring."""
from __future__ import annotations

import warnings as _warnings

_warnings.warn(
    "Importing `production_transformer_rage` is deprecated since v0.1.0a3. "
    "Use `from neuralnet.transformer_rage import ...` instead. "
    "This shim will be removed in 0.2.0.",
    DeprecationWarning,
    stacklevel=2,
)

from neuralnet.transformer_rage import *  # noqa: F401, F403
